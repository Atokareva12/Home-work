...
$ceu = array("Италия" => "Рим","<br>" , "Люксембург" => "Люксембург", "<br>", 
"Бельгия" => "Брюссель", "<br>" , "Дания" => "Копенгаген", "<br>" , 
"Финляндия" => "Хельсинки", "<br>", "Франция "=>"Париж", "<br>" , 
"Словакия"=>"Братислава","<br>" , "Словения"=>"Любляна", "<br>" , "Германия"=>"Берлин","<br>", 
"Греция"=>"Афины", "<br>" , "Ирландия" => "Дублин","<br>",  "Нидерланды" => "Амстердам", "<br>", 
"Португалия" => "Лиссабон", "<br>" , "Испания" => "Мадрид","<br>",  
"Швеция" => "Стокгольм", "<br>", "Великобритания" => "Лондон",  "<br>", 
"Кипр"=>"Никосия", "<br>" , "Литва"=>"Вильнюс", "<br>", 
"Чехия"=>"Прага","<br>" ,  "Эстония"=>"Таллин","<br>" , " Польша "=>"Варшава","<br>" );
asort($ceu);
